        ...
        <ul class="slider">
            <li class="">
                ...
                <a href="#" data-rel="prettyphoto[]" target="_blank">
                    <img src="{{asset('assets/extra-images/banner-01.jpg')}}" alt="Image here">
                    <div class="iq-caption-wrapper text-left">
                        <div class="iq_banner_caption container">
                            <div class="iq-caption">
                                ...
                                <div class="iq-caption-contant">Lorem ipsum dolor sit amet, consectetur adipiscing
                                    elit
                                </div>
            ...
            <li class="">
                <!--Banner Thumb START-->
                <a href="#" data-rel="prettyphoto[]" target="_blank">
                    <img src="{{asset('assets/extra-images/banner-02.jpg')}}" alt="Image here">
            ...
            <li class="">
                <!--Banner Thumb START-->
                <a href="#" data-rel="prettyphoto[]" target="_blank">
                    <img src="{{asset('assets/extra-images/banner-03.jpg')}}" alt="Image here">
                        ...
                        <section>
                            ...
                            <div class="iq_heading_1 text-left">
                                ...
                                <p>This is Photoshop's version of Lorem Ipsum. Proin gravida nibh vel velit auctor
                                    ...
                                    <br>lorem quis bibendum auctor, nisi elit consequat ipsum, nec sagittis sem nibh id
                                    elit.</p>
                            </div>
                            <!--Heading Wrap End-->
                            <div class="row">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <div class="iq_professional_services">
                                        ...
                                        <p>This is Photoshop's version of Lorem Ipsum. Proin gravida nibh vel velit
                                            auctor aliquet. Aenean lorem quis bibendum auctor, nisi elit consequat ipsum
                                            nec sagittis.</p>
                                    </div>
                                </div>
                                <!--Services End-->
                ...
                <div id="my-tab-content" class="tab-content">
                    <div class="row tab-pane active" id="featured">
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="iq_course_list">
                                <figure>
                                    <img src="{{asset('assets/extra-images/featured-course-1.jpg')}}" alt="Image Here">
                                </figure>
                                <div class="iq_course_list_des">
                                    ...
                                    <p>This is Photoshop's version of Lorem Ipsum. Proin gravida nibh vel velit auctor
                                        aliquet. Aenean sollicitudin, lorem quis bibendum </p>
                                    <ul>
                                        <li>
                                            <!--RATING AREA START-->
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="iq_course_list">
                                <figure>
                                    <img src="{{asset('assets/extra-images/featured-course-02.jpg')}}" alt="Image Here">
                                </figure>
                                <div class="iq_course_list_des">
                                    <div class="iq_course_icon">
                                                <span class="icon-lecture">
                        ...
                        <div class="col-md-4 hidden-sm">
                            <div class="iq_course_list">
                                <figure>
                                    <img src="{{asset('assets/extra-images/featured-course-03.jpg')}}" alt="Image Here">
                                </figure>
                                <div class="iq_course_list_des">
                                    <div class="iq_course_icon">
                    ...
                    <div class="row tab-pane" id="popular">
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="iq_course_list">
                                <figure>
                                    <img src="{{asset('assets/extra-images/featured-course-01.jpg')}}" alt="Image Here">
                                </figure>
                                <div class="iq_course_list_des">
                                    <div class="iq_course_icon">
                                                <span class="icon-doctor-2">
        ...
        <section class="iq_gallery_bg">
            ...
            <div id="filterable-item-holder-1" class="filterable_container main-gallery">
                ...
                <div class="col-md-4 col-sm-6 filterable-item all 1 2 3">
                    <div class="thumb">
                        <figure>
                            <img src="{{asset('assets/extra-images/gallery-01.jpg')}}" alt="Image Here">
                ...
                <div class="col-md-4 col-sm-6 filterable-item all 1  5">
                    <div class="thumb">
                        <figure>
                            <img src="{{asset('assets/extra-images/gallery-02.jpg')}}" alt="Image Here">
                            <figcaption class="overlay1">
                                <div class="link-wrapper">
                                    <a href="#"><i class="fa fa-search"></i></a>
                                    <a href="#"><i class="fa fa-link"></i></a>
                ...
                <div class="col-md-4 col-sm-6 filterable-item all 1 2 5">
                    <div class="thumb">
                        <figure>
                            <img src="{{asset('assets/extra-images/gallery-03.jpg')}}" alt="Image Here">
                            <figcaption class="overlay1">
                                <div class="link-wrapper">
                                    <a href="#"><i class="fa fa-search"></i></a>
                                    <a href="#"><i class="fa fa-link"></i></a>
                ...
                <div class="col-md-4 col-sm-6 filterable-item all  2 4">
                    <div class="thumb">
                        <figure>
                            <img src="{{asset('assets/extra-images/gallery-04.jpg')}}" alt="Image Here">
                            <figcaption class="overlay1">
                                <div class="link-wrapper">
                                    <a href="#"><i class="fa fa-search"></i></a>
                                    <a href="#"><i class="fa fa-link"></i></a>
                ...
                <div class="col-md-4 col-sm-6 filterable-item all 1 2">
                    <div class="thumb">
                        <figure>
                            <img src="{{asset('assets/extra-images/gallery-05.jpg')}}" alt="Image Here">
                            <figcaption class="overlay1">
                                <div class="link-wrapper">
                                    <a href="#"><i class="fa fa-search"></i></a>
                                    <a href="#"><i class="fa fa-link"></i></a>
                ...
                <div class="col-md-4 col-sm-6 filterable-item all 1 3">
                    <div class="thumb">
                        <figure>
                            <img src="{{asset('assets/extra-images/gallery-06.jpg')}}" alt="Image Here">
                            <figcaption class="overlay1">
                                <div class="link-wrapper">
                                    <a href="#"><i class="fa fa-search"></i></a>
                                    <a href="#"><i class="fa fa-link"></i></a>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="iq_upcomming_event">
                            <figure>
                                <img src="{{asset('assets/extra-images/upcomming-event-01.jpg')}}" alt="Image Here">
                            </figure>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="iq_upcomming_event">
                            <figure>
                                <img src="{{asset('assets/extra-images/upcomming-event-02.jpg')}}" alt="Image Here">
                            </figure>
                            <div class="iq_upcomming_des">
                                <span>21 aug</span>
                                <p>10:00 am</p>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="iq_upcomming_event">
                            <figure>
                                <img src="{{asset('assets/extra-images/upcomming-event-03.jpg')}}" alt="Image Here">
                            </figure>
                            <div class="iq_upcomming_des">
                                <span>21 aug</span>
                                <p>10:00 am</p>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="iq_upcomming_event">
                            <figure>
                                <img src="{{asset('assets/extra-images/upcomming-event-04.jpg')}}" alt="Image Here">
                            </figure>
                            <div class="iq_upcomming_des">
                                <span>21 aug</span>
                                <p>10:00 am</p>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="iq_upcomming_event">
                            <figure>
                                <img src="{{asset('assets/extra-images/upcomming-event-05.jpg')}}" alt="Image Here">
                            </figure>
                            <div class="iq_upcomming_des">
                                <span>21 aug</span>
                                <p>10:00 am</p>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="iq_upcomming_event">
                            <figure>
                                <img src="{{asset('assets/extra-images/upcomming-event-06.jpg')}}" alt="Image Here">
                            </figure>
                            <div class="iq_upcomming_des">
                                <span>21 aug</span>
                                <p>10:00 am</p>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="iq_upcomming_event">
                            <figure>
                                <img src="{{asset('assets/extra-images/upcomming-event-07.jpg')}}" alt="Image Here">
                            </figure>
                            <div class="iq_upcomming_des">
                                <span>21 aug</span>
                                <p>10:00 am</p>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="iq_upcomming_event">
                            <figure>
                                <img src="{{asset('assets/extra-images/upcomming-event-08.jpg')}}" alt="Image Here">
                            </figure>
                            <div class="iq_upcomming_des">
                                <span>21 aug</span>
                                <p>10:00 am</p>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-6">
                        <div class="iq_teacher_style_1">
                            <figure>
                                <img src="{{asset('assets/extra-images/teacher-01.jpg')}}" alt="Image Here">
                            </figure>
                            <div class="text">
                    ...
                    <div class="col-md-4 col-sm-6">
                        <div class="iq_teacher_style_1">
                            ...
                            <figure>
                                <img src="{{asset('assets/extra-images/teacher-02.jpg')}}" alt="Image Here">
                            </figure>
                        </div>
                    </div>
                    <!--Teacher Thumb End-->
                    ...
                    <div class="col-md-4 hidden-sm">
                        <div class="iq_teacher_style_1">
                            <figure>
                                <img src="{{asset('assets/extra-images/teacher-03.jpg')}}" alt="Image Here">
                            </figure>
                            <div class="text">
                ...
                <div class="blog-slider">
                    <div class="col-md-4 col-sm-6">
                        ...
                        <div class="center-dec">
                            <figure>
                                <img src="{{asset('assets/extra-images/center-img.jpg')}}" alt="">
                            </figure>
                            <div class="text">
                                <h5><a href="#">Sed ut perspiciatis unde omnis iste natus error sit</a></h5>
                                <p>Nullam ac urna eu felis dapibus condimentum sit amet a augue. Sed non neque elit. Sed
                                    ut imperdiet nisi. Proin condimentum fermentum nunc.</p>
                    ...
                    <div class="col-md-4 col-sm-6">
                        ...
                        <div class="center-dec">
                            <figure>
                                <img src="{{asset('assets/extra-images/center-img2.jpg')}}" alt="">
                            </figure>
                            <div class="text">
                                <h5><a href="#">Sed ut perspiciatis unde omnis iste natus error sit</a></h5>
                                <p>Nullam ac urna eu felis dapibus condimentum sit amet a augue. Sed non neque elit. Sed
                    ...
                    <div class="col-md-4 col-sm-6">
                        ...
                        <div class="center-dec">
                            <figure>
                                <img src="{{asset('assets/extra-images/center-img3.jpg')}}" alt="">
                            </figure>
                            <div class="text">
                                <h5><a href="#">Sed ut perspiciatis unde omnis iste natus error sit</a></h5>
                                <p>Nullam ac urna eu felis dapibus condimentum sit amet a augue. Sed non neque elit. Sed
                ...
                <div class="testimonial-slider">
                    ...
                    <div>
                        <div class="testimonial">
                            <p>“ Education WP Theme is a comprehensive LMS solution for WordPress Theme. This beautiful
                                theme based on LearnPress - the best WordPress LMS plugin. Education WP theme will bring
                                you the best LMS experience ever with super friendly UX and complete eLearning features.
                                ”</p>
                            <div class="coures_instractor_thumb">
                                <figure>
                                    <img src="{{asset('assets/extra-images/testimonial-nav1.jpg')}}" alt="">
                                </figure>
                    ...
                    <div>
                        <div class="testimonial">
                            ...
                            <div class="coures_instractor_thumb">
                                <figure>
                                    <img src="{{asset('assets/extra-images/testimonial-nav2.jpg')}}" alt="">
                                </figure>
                                <div class="thumb_capstion">
                                    <h5><a href="#">Jonatahan James</a></h5>
                                    <p>Former Student</p>
                    ...
                    <div>
                        <div class="testimonial">
                            ...
                            <div class="coures_instractor_thumb">
                                <figure>
                                    <img src="{{asset('assets/extra-images/testimonial-nav3.jpg')}}" alt="">
                                </figure>
                                <div class="thumb_capstion">
                                    <h5><a href="#">Jonatahan James</a></h5>
                                    <p>Former Student</p>
    ...
    <div class="brnd-slider-wrap">
        <div class="container">
            <div class="brnd-slider">
                <div>
                    <a href="#" class="thumb">
                        <img src="{{asset('assets/extra-images/brand1.png')}}" alt="">
                    </a>
                </div>
                <div>
                    <a href="#" class="thumb">
                        <img src="{{asset('assets/extra-images/brand2.png')}}" alt="">
                    </a>
                </div>
                <div>
                    <a href="#" class="thumb">
                        <img src="{{asset('assets/extra-images/brand3.png')}}" alt="">
                    </a>
                </div>
                <div>
                    <a href="#" class="thumb">
                        <img src="{{asset('assets/extra-images/brand4.png')}}" alt="">
                    </a>
                </div>
                <div>
                    <a href="#" class="thumb">
                        <img src="{{asset('assets/extra-images/brand5.png')}}" alt="">
                    </a>
                </div>
                <div>
                    <a href="#" class="thumb">
                        <img src="{{asset('assets/extra-images/brand6.png')}}" alt="">
                    </a>
                </div>
                <div>
                    <a href="#" class="thumb">
